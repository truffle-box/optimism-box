...
export declare class EthModule {
    ...
    constructor(_common: Common, _node: BuidlerNode, _throwOnTransactionFailures: boolean, _throwOnCallFailures: boolean, _logger?: ModulesLogger | undefined, _experimentalBuidlerEVMMessageTraceHooks?: BoundExperimentalBuidlerEVMMessageTraceHook[]);
    ...
    private _logTo;
    private _runBuidlerEVMMessageTraceHooks;
}
