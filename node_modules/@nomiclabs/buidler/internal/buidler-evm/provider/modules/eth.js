...
class EthModule {
    constructor(_common, _node, _throwOnTransactionFailures, _throwOnCallFailures, _logger, _experimentalBuidlerEVMMessageTraceHooks = []) {
    ...
    async _blockTagToBlockNumber(blockTag) {
        ...
        if (blockTag === undefined || blockTag === "latest") {
            ...
            block = await this._node.getBlockByNumber(new ethereumjs_util_1.BN(blockNumber));
        }
    ...
    async _runBuidlerEVMMessageTraceHooks(trace, isCall) {
