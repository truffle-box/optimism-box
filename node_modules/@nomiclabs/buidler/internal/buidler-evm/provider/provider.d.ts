...
import { BoundExperimentalBuidlerEVMMessageTraceHook, EthereumProvider, ProjectPaths } from "../../../types";
...
export declare class BuidlerEVMProvider extends EventEmitter implements EthereumProvider {
    ...
    private readonly _experimentalBuidlerEVMMessageTraceHooks;
    private _common?;
    private _node?;
    private _ethModule?;
    private _netModule?;
    ...
    constructor(_hardfork: string, _networkName: string, _chainId: number, _networkId: number, _blockGasLimit: number, _throwOnTransactionFailures: boolean, _throwOnCallFailures: boolean, _genesisAccounts?: GenesisAccount[], _solcVersion?: string | undefined, _paths?: ProjectPaths | undefined, _loggingEnabled?: boolean, _allowUnlimitedContractSize?: boolean, _initialDate?: Date | undefined, _experimentalBuidlerEVMMessageTraceHooks?: BoundExperimentalBuidlerEVMMessageTraceHook[]);
