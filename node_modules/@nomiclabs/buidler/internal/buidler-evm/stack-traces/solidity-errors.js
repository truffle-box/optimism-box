...
function encodeStackTraceEntry(stackTraceEntry) {
    switch (stackTraceEntry.type) {
        ...
        case solidity_stack_trace_1.StackTraceEntryType.INTERNAL_FUNCTION_CALLSTACK_ENTRY:
            return new SolidityCallSite(stackTraceEntry.sourceReference.file.globalName, stackTraceEntry.sourceReference.contract, `internal@${stackTraceEntry.pc}`, undefined);
...
function sourceReferenceToSolidityCallsite(sourceReference) {
    return new SolidityCallSite(sourceReference.file.globalName, sourceReference.contract, sourceReference.function !== undefined
