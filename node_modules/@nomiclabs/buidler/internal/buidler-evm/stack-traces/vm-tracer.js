...
class VMTracer {
    constructor(_vm, _dontThrowErrors = false) {
        this._vm = _vm;
        ...
        this._getContractCode = util_1.promisify(this._vm.stateManager.getContractCode.bind(this._vm.stateManager));
    }
    enableTracing() {
    ...
    getLastTopLevelMessageTrace() {
        ...
        if (this._messageTraces.length === 0) {
            throw new Error("You can't get a vm trace if no message was executed yet");
        }
