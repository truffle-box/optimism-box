...
You can learn hoy to use Buidler by reading the [Getting Started guide](./README.md).`,
        ...
        INVALID_NODE_VERSION: {
            number: 2,
            message: "Buidler doesn't support your Node.js version. It should be %requirement%.",
...
Please [report it](https://github.com/nomiclabs/buidler/issues/new) to help us improve Buidler.`,
        ...
        CONTEXT_BRE_NOT_DEFINED: {
            number: 6,
            message: "Buidler Runtime Environment is not defined in the BuidlerContext.",
...
Please [report it](https://github.com/nomiclabs/buidler/issues/new) to help us improve Buidler.`,
        ...
        CONTEXT_BRE_ALREADY_DEFINED: {
            number: 7,
            message: "Buidler Runtime Environment is already defined in the BuidlerContext",
...
Please [report it](https://github.com/nomiclabs/buidler/issues/new) to help us improve Buidler.`,
        ...
        CONTEXT_CONFIG_PATH_NOT_SET: {
            number: 11,
            message: "Trying to access the BuidlerContext's config path field but it wasn't set",
...
Please make sure you are setting your config correctly.`,
        ...
        DEPRECATED_INVALID_TX_CHAIN_ID: {
            number: 102,
            message: "Trying to send a tx with chain id %txChainId%, but Buidler is connected to a chain with id %chainId%.",
...
Please double check your task definitions.`,
        ...
        PARAM_CLASHES_WITH_BUIDLER_PARAM: {
            number: 202,
            message: "Could not set param %paramName% for task %taskName% because its name is used as a param for Buidler.",
...
Please double check your task definitions.`,
        ...
        OVERRIDE_NO_PARAMS: {
            number: 204,
            message: "Redefinition of task %taskName% failed. You can't change param definitions in an overridden task.",
...
This is disabled for security reasons.`,
        ...
        LIBRARY_FILE_NOT_LOCAL: {
            number: 402,
            message: "File %file% belongs to a library but was treated as a local one.",
...
This is disabled for security reasons.`,
        ...
        FILE_OUTSIDE_LIB: {
            number: 406,
            message: "File %file% from %library% is resolved to a path outside of its library.",
            title: "Illegal Solidity import",
            description: `One of your libraries tried to use a relative import to import a file outside of its scope. 
...
Please double check your \`solc\` config.`,
        ...
        DOWNLOAD_FAILED: {
            number: 501,
            message: "Couldn't download compiler version %remoteVersion%. Please check your connection or use local version %localVersion%",
...
Please check your Internet connection.`,
        ...
        VERSION_LIST_DOWNLOAD_FAILED: {
            number: 502,
            message: "Couldn't download compiler versions list. Please check your connection or use local version %localVersion%",
...
Please check your Internet connection.`,
        ...
        INVALID_DOWNLOAD: {
            number: 503,
            message: "Couldn't download compiler version %remoteVersion%. Checksum verification failed. Please check your connection or use local version %localVersion%",
...
We recommend not using this kind of dependencies.`,
        ...
        JSONRPC_UNSUPPORTED_NETWORK: {
            number: 606,
            message: "Unsupported network for JSON-RPC server. Only buidlerevm is currently supported.",
