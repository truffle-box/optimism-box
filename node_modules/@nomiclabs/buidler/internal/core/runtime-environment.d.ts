import { BuidlerArguments, BuidlerRuntimeEnvironment, EnvironmentExtender, EthereumProvider, ExperimentalBuidlerEVMMessageTraceHook, Network, ResolvedBuidlerConfig, RunTaskFunction, TasksMap } from "../../types";
export declare class Environment implements BuidlerRuntimeEnvironment {
     ...
     */
    constructor(config: ResolvedBuidlerConfig, buidlerArguments: BuidlerArguments, tasks: TasksMap, extenders?: EnvironmentExtender[], experimentalBuidlerEVMMessageTraceHooks?: ExperimentalBuidlerEVMMessageTraceHook[]);
    /**
