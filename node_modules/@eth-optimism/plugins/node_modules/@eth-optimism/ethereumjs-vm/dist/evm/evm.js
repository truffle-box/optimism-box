...
var EVM = /** @class */ (function () {
    ...
    EVM.prototype.executeMessage = function (message) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var code, isTargetMessage, result, code, isECDSAContractAccount, target, _b, _c, err, wasDeployException, returnData, EOAReturnedFalse, exceptionError;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _d.sent();
                        if (!(message.depth === 0)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this._state.getContractCode(message.caller)];
                    case 3:
                        code = _d.sent();
                        if (!(code.length === 0)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this._state.putContractCode(message.caller, buffer_utils_1.fromHexString(this._vm.contracts.mockOVM_ECDSAContractAccount.code))];
                    case 4:
                        _d.sent();
                        _d.label = 5;
                    case 5:
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, this._vm.ovmStateManager.handleCall(message, this._tx)];
                    case 8:
                        result = (_b.execResult = (_c.returnValue = _d.sent(),
                            _c),
                            _b);
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, this._executeCall(message)];
                    case 10:
                        result = _d.sent();
                        _d.label = 11;
                    case 11: return [3 /*break*/, 14];
                    case 12: return [4 /*yield*/, this._executeCreate(message)];
                    case 13:
                        result = _d.sent();
                        _d.label = 14;
                    case 14:
                        ...
                        if (!err) return [3 /*break*/, 16];
                        result.execResult.logs = [];
                        return [4 /*yield*/, this._state.revert()];
                    case 15:
                        _d.sent();
                        return [3 /*break*/, 18];
                    case 16: return [4 /*yield*/, this._state.commit()];
                    case 17:
                        _d.sent();
                        _d.label = 18;
                    case 18:
                        ...
                        wasDeployException = false;
                        if (message.depth === 0) {
                            if (this._targetMessageResult) {
                                if (result.execResult.logs) {
                                    result.execResult.logs = result.execResult.logs.filter(function (log) {
                                        return !log[0].equals(_this._vm.contracts.OVM_ExecutionManager.address);
                                    });
                                }
                                returnData = this._targetMessageResult.execResult.returnValue;
                                if (!!this._targetMessageResult.execResult.exceptionError && returnData.byteLength >= 160) {
                                    returnData = returnData.slice(160);
                                }
                                result.execResult.exceptionError;
                                EOAReturnedFalse = ((_a = this._accountMessageResult) === null || _a === void 0 ? void 0 : _a.execResult.returnValue.slice(0, 32).toString('hex')) ==
                                    '00'.repeat(32);
                                wasDeployException =
                                    EOAReturnedFalse && !this._targetMessageResult.execResult.exceptionError;
                                exceptionError = wasDeployException
                                    ? new exceptions_1.VmError(exceptions_1.ERROR.REVERT)
                                    : this._targetMessageResult.execResult.exceptionError;
                                result = __assign(__assign({}, result), { createdAddress: this._targetMessageResult.createdAddress, execResult: __assign(__assign({}, result.execResult), { returnValue: returnData, exceptionError: exceptionError }) });
                            }
                            else {
                                // todo: detect OVM-specific error cases and surface here
                                result.execResult.exceptionError = new exceptions_1.VmError(exceptions_1.ERROR.OVM_ERROR);
                            }
                        }
                        if (message.depth == 1 &&
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        ...
                        _b.sent();
                        if (!message.code || message.code.length === 0) {
                            console.error("Could not load code for: " + buffer_utils_1.toHexString(message.to));
                            return [2 /*return*/, {
                                    gasUsed: new BN(0),
                                    createdAddress: message.to,
                                    execResult: {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._state.getContractStorage(this._vm.contracts.OVM_ExecutionManager.address, Buffer.from('00'.repeat(31) + '0f', 'hex'))];
