...
exports.getContractDefinition = (name, ovm) => {
    return require(path.join(__dirname, `../artifacts/${ovm ? 'ovm' : 'evm'}`, `${name}.json`));
};
exports.getContractInterface = (name, ovm) => {
    const definition = exports.getContractDefinition(name, ovm);
    return new ethers_1.ethers.utils.Interface(definition.abi);
};
exports.getContractFactory = (name, signer, ovm) => {
    const definition = exports.getContractDefinition(name, ovm);
